...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-09-2024 a las 19:45:40
...
--
-- Base de datos: `bd_bytesandbits_grupo1`
--
...
(200, 'Juegos de destornilladores de precisión', 12, 11, '66-752', 100.00, 'https://www.materialessorrento.com/cdn/shop/files/JUE-STA-66052_56596998-023d-409f-80d5-7f095347a906_800x.jpg?v=1721561612', 24, 3, 'Herramientas indispensables para manipular componentes electrónicos pequeños y delicados en reparaciones.', 1),
(201, 'Pinzas de punta fina', 12, 15, 'T0053695299', 100.00, '', 32, 2, 'Útiles para manejar pequeños cables, componentes y realizar ajustes de precisión en espacios reducidos.', 1),
(202, 'Estaciones de soldadura y desoldadura', 11, 15, 'WESD51', 3000.00, '', 22, 1, 'Equipos necesarios para reparar y ensamblar componentes electrónicos mediante la aplicación o remoción de soldadura.', 1),
(203, 'Multímetro digital', 10, 10, 'MT-3', 500.00, '', 32, 3, 'Instrumento versátil para medir voltaje, corriente y resistencia, ideal para diagnósticos electrónicos.', 2),
(204, 'discos duro toshiba 500 GB HDD', 9, 17, 'L200', 300.00, '', 31, 6, 'Almacenamiento confiable para guardar grandes cantidades de datos y archivos.', 2),
(205, 'discos duro  kingston 1TB SSD ', 9, 16, 'KC2000', 800.00, '', 28, 6, 'Unidades de almacenamiento de alta velocidad que mejoran el rendimiento del sistema.', 1),
(206, 'disco duro Western Digital (WD) 1 TB HDD', 9, 19, 'WD Blue', 500.00, '', 15, 5, 'Soluciones económicas de gran capacidad para almacenamiento de datos.', 2),
(207, 'dico duro Seagate 500GB HDD', 9, 20, 'Barracuda', 600.00, '', 16, 6, 'Almacenamiento confiable para guardar grandes cantidades de datos y archivos.', 1),
(208, 'RAM ddr3 4gb', 8, 18, 'Vengeance LPX', 400.00, '', 20, 4, 'Módulos de memoria que mejoran el rendimiento en sistemas más antiguos.', 2),
(209, 'RAM ddr3 8gb', 8, 16, 'ValueRAM', 600.00, '', 18, 5, 'Módulos de memoria que mejoran el rendimiento en sistemas más antiguos.', 2),
(210, 'RAM ddr3 16gb', 8, 18, 'Dominator Platinum', 800.00, '', 19, 5, 'Módulos de memoria que mejoran el rendimiento en sistemas más antiguos.', 2),
(211, 'RAM ddr4 4gb', 8, 16, 'HyperX Predator', 500.00, '', 24, 5, 'Módulos de alta velocidad que incrementan el rendimiento en tareas de computación modernas.', 2),
(212, 'RAM ddr4 8gb', 8, 18, 'Vengeance RGB Pro', 800.00, '', 16, 4, 'Módulos de alta velocidad que incrementan el rendimiento en tareas de computación modernas.', 1),
(213, 'RAM ddr4 16gb', 8, 16, 'HyperX Fury', 1200.00, '', 32, 4, 'Módulos de alta velocidad que incrementan el rendimiento en tareas de computación modernas.', 1),
(214, 'RAM ddr4 32gb', 8, 18, 'Vengeance LPX', 1500.00, '', 24, 4, 'Módulos de alta velocidad que incrementan el rendimiento en tareas de computación modernas.', 1),
(215, 'Tarjetas gráficas nvidia rtx 3060', 7, 7, 'rtx 3060', 3500.00, '', 18, 6, 'Potentes unidades de procesamiento gráfico ideales para juegos avanzados y aplicaciones de alto rendimiento visual.', 1),
(216, 'Tarjetas gráficas nvidia rtx 3080', 7, 7, 'rtx 3080', 4000.00, '', 16, 6, 'Potentes unidades de procesamiento gráfico ideales para juegos avanzados y aplicaciones de alto rendimiento visual.', 1),
(217, 'Tarjetas gráficas nvidia rtx 3090', 7, 7, 'rtx 3090', 5000.00, '', 14, 6, 'Potentes unidades de procesamiento gráfico ideales para juegos avanzados y aplicaciones de alto rendimiento visual.', 1),
(218, 'Procesador (Intel® Core™ Ultra 9)', 14, 21, 'Intel Core Ultra 9 14900H', 4200.00, '', 11, 5, 'Procesador de alto rendimiento diseñado para laptops de gama alta y estaciones de trabajo portátiles. ', 1),
(219, 'Unidad de Fuente de Alimentación', 15, 3, 'H360EGM-00', 1256.00, '', 24, 2, 'Ofrece una alimentación estable y confiable para asegurar el correcto funcionamiento de tu equipo.', 1),
(220, 'Pasta térmica', 16, 20, 'TM30', 250.00, '', 21, 6, 'Es una opción asequible, pero con un rendimiento decente para aplicaciones en procesadores y tarjetas gráficas. ', 1);
