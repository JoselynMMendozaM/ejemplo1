...
--
create database if not exists bd_grupo1;
use bd_grupo1;
...
INSERT INTO `repuestos` (`id_repuesto`, `nombre`, `id_tipo_equipo`, `id_marca`, `modelo`, `precio`, `img_repuesto`, `id_proveedor`, `descripcion`) VALUES
(200, 'Juegos de destornilladores de precisión', 12, 11, '66-752', 100.00, '', 3, 'Herramientas indispensables para manipular componentes electrónicos pequeños y delicados en reparaciones.'),
(201, 'Pinzas de punta fina', 12, 15, 'T0053695299', 100.00, '', 2, 'Útiles para manejar pequeños cables, componentes y realizar ajustes de precisión en espacios reducidos.'),
(202, 'Estaciones de soldadura y desoldadura', 11, 15, 'WESD51', 3000.00, '', 1, 'Equipos necesarios para reparar y ensamblar componentes electrónicos mediante la aplicación o remoción de soldadura.'),
(203, 'Multímetro digital', 10, 10, 'MT-3', 500.00, '', 3, 'Instrumento versátil para medir voltaje, corriente y resistencia, ideal para diagnósticos electrónicos.'),
(204, 'discos duro toshiba 500 GB HDD', 9, 17, 'L200', 300.00, '', 6, 'Almacenamiento confiable para guardar grandes cantidades de datos y archivos.'),
(205, 'discos duro  kingston 1TB SSD ', 9, 16, 'KC2000', 800.00, '', 6, 'Unidades de almacenamiento de alta velocidad que mejoran el rendimiento del sistema.'),
(206, 'disco duro Western Digital (WD) 1 TB HDD', 9, 19, 'WD Blue', 500.00, '', 5, 'Soluciones económicas de gran capacidad para almacenamiento de datos.'),
(207, 'dico duro Seagate 500GB HDD', 9, 20, 'Barracuda', 600.00, '', 6, 'Almacenamiento confiable para guardar grandes cantidades de datos y archivos.'),
(208, 'RAM ddr3 4gb', 8, 18, 'Vengeance LPX', 400.00, '', 4, 'Módulos de memoria que mejoran el rendimiento en sistemas más antiguos.'),
(209, 'RAM ddr3 8gb', 8, 16, 'ValueRAM', 600.00, '', 5, 'Módulos de memoria que mejoran el rendimiento en sistemas más antiguos.'),
(210, 'RAM ddr3 16gb', 8, 18, 'Dominator Platinum', 800.00, '', 5, 'Módulos de memoria que mejoran el rendimiento en sistemas más antiguos.'),
(211, 'RAM ddr4 4gb', 8, 16, 'HyperX Predator', 500.00, '', 5, 'Módulos de alta velocidad que incrementan el rendimiento en tareas de computación modernas.'),
(212, 'RAM ddr4 8gb', 8, 18, 'Vengeance RGB Pro', 800.00, '', 4, 'Módulos de alta velocidad que incrementan el rendimiento en tareas de computación modernas.'),
(213, 'RAM ddr4 16gb', 8, 16, 'HyperX Fury', 1200.00, '', 4, 'Módulos de alta velocidad que incrementan el rendimiento en tareas de computación modernas.'),
(214, 'RAM ddr4 32gb', 8, 18, 'Vengeance LPX', 1500.00, '', 4, 'Módulos de alta velocidad que incrementan el rendimiento en tareas de computación modernas.'),
(215, 'Tarjetas gráficas nvidia rtx 3060', 7, 7, 'rtx 3060', 3500.00, '', 6, 'Potentes unidades de procesamiento gráfico ideales para juegos avanzados y aplicaciones de alto rendimiento visual.'),
(216, 'Tarjetas gráficas nvidia rtx 3080', 7, 7, 'rtx 3080', 4000.00, '', 6, 'Potentes unidades de procesamiento gráfico ideales para juegos avanzados y aplicaciones de alto rendimiento visual.'),
(217, 'Tarjetas gráficas nvidia rtx 3090', 7, 7, 'rtx 3090', 5000.00, '', 6, 'Potentes unidades de procesamiento gráfico ideales para juegos avanzados y aplicaciones de alto rendimiento visual.'),
(218, 'Procesador (Intel® Core™ Ultra 9)', 14, 21, 'Intel Core Ultra 9 14900H', 4200.00, '', 5, 'Procesador de alto rendimiento diseñado para laptops de gama alta y estaciones de trabajo portátiles. '),
(219, 'Unidad de Fuente de Alimentación', 15, 3, 'H360EGM-00', 1256.00, '', 2, 'Ofrece una alimentación estable y confiable para asegurar el correcto funcionamiento de tu equipo.'),
(220, 'Pasta térmica', 16, 20, 'TM30', 250.00, '', 6, 'Es una opción asequible, pero con un rendimiento decente para aplicaciones en procesadores y tarjetas gráficas. ');
...
--
ALTER TABLE `clientes`
  MODIFY `id_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20240020;
...
-- secuencia de id clientes
CREATE SEQUENCE secuencia_clientes START WITH 20240020;

-- Para usar la secuencia en una tabla clientes:
ALTER TABLE clientes
  MODIFY COLUMN id_cliente INT NOT NULL DEFAULT NEXT VALUE FOR secuencia_clientes;
  
  -- secuencia de id empleados
  CREATE SEQUENCE secuencia_empleados START WITH 10018;

-- Para usar la secuencia en una tabla empleados:
ALTER TABLE empleados
  MODIFY COLUMN id_empleado INT NOT NULL DEFAULT NEXT VALUE FOR secuencia_empleados;